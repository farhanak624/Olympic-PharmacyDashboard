          ...
          >
            ...
            {selectedValues.length > 0
              ? selectedValues.map((value, index) => (
                  <div
                    key={value}
                    className="bg-containerLight rounded-md flex text-nowrap items-center px-2 py-1 mr-2 text-textColor"
                  >
                    {value}
                    <button
                      type="button"
            ...
            <ul className="py-1">
              {optionlist.map((option, index) => (
                <li
                  ...
                  className={`px-4 py-2 cursor-pointer border rounded-lg text-nowrap text-textColor hover:bg-subContainerColor
                    ${
