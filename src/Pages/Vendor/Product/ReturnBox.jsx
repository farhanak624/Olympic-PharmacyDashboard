      ...
      <div className="relative flex items-start">
        <div className="flex items-center h-5 mt-1">
          <input
            ...
            value={true}
            type="radio"
            className="border-gray-200 rounded-full accent-navblue "
        ...
        <label htmlFor="hs-radio-delete" className="ms-3">
          <span className="block text-sm font-semibold text-textColor mt-1">
            Yes
          </span>
        </label>
      </div>
      ...
      {returnAllowed && (
        <div className="flex">
          <input
            ...
            className="p-1 rounded-lg shadow shadow-black/20 text-textColor outline-none bg-subContainerColor border-none flex-1"
