...
const ChartComponent = ({
  ...
  return (
    <div className="w-full flex gap-2 h-[90%]">
      <div className=" w-[45%]">
        <h1 className="text-white">Total Orders</h1>
        ...
        <div className="flex gap-4 items-center">
          {/* salecolor */}
          <div className="mt-3">
            <p className="text-xs text-gray-500 py-2"> Best sale month</p>
            <div
          ...
          {/* frist end */}
          <div className="mt-3">
            <p className="text-xs text-gray-500 py-2"> Least sale month</p>
            <div
              className="crad text-xs text-gray-900 p-1 rounded-lg pl-4"
      ...
      <div id="labels-chart" className=" w-full"></div>
    </div>
  );
};
